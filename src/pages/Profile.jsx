...
//                         className='bg-gray-100 pl-2 text-xl shadow-md h-12 w-45 mr-10 rounded-md' 
//                     />
//                     <input 
//                         type="text" 
//                         name="lastname"
...
//                         onChange={handleChange}
//                         className='bg-gray-50 h-12 pl-2 text-xl w-45 shadow-md rounded-sm' 
//                     />
//                 </div>
...
//                         onChange={handleChange}
//                         className='bg-gray-50 pl-2 h-12 mr-10 w-45 shadow-md rounded-sm' 
//                     />
//                     <input 
//                         type="tel" 
//                         name="phoneNumber"
...
//                         onChange={handleChange}
//                         className='bg-gray-50 h-12 pl-2 w-45 shadow-md rounded-sm' 
//                     />
//                 </div>
//                 <div className='mt-5'>
...
//                         onChange={handleChange}
//                         className='bg-gray-50 h-12 pl-2 w-105 mr-10 rounded-sm shadow-md text-xl' 
//                     />
//                 </div>
//             </div>
//             <button 
//                 className='h-10 w-50 mt-5 bg-violet-400 text-white shadow-lg cursor-pointer rounded-sm hover:bg-violet-300'
